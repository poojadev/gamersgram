...
/*
       Game publisher list
     */
//Widget publisherGalleryWidget(GamePublisherPOJO publisherList)
//{   return
...
//                shrinkWrap: true,
//                itemCount: publisherList == null ? 0 :5,
...
//                            builder: (context) => PublisherDetailsState(id: publisherList.results[index].id,
//                            ) ));
//                      },
//                      child: AnimationConfiguration.staggeredGrid(
//                          position: index,
//                          duration: const Duration(milliseconds: 375),
//                          columnCount: publisherList.results.length,
...
//                                                  child: Text(
//                                                    '${publisherList.results[index].name}',
...
//                shrinkWrap: true,
                ...
                shrinkWrap: true,
                itemCount: publisherList == null ? 0 : publisherList.results
                    .length,
                itemBuilder: (context, index) {
...
//                                          context,
//                                          NavSlideFromRight(
//                                              page: PublisherDetailsState(
//                                                publisherId: publisherList
//                                                    .results[index].id,
//                                                publisherName: publisherList
//                                                    .results[index].name,
//                                                pageDirection: 1,
//                                              )));
                                      ...
                                      YoutubeArguments publisherDetailsArguments=new YoutubeArguments(
                                        gameId: publisherList.results[index].id,
                                        gameName: publisherList.results[index].name,
                                        flag: 1,
                                      );
