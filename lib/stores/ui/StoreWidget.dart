...
//
//  Widget gamesStoreWidget(GameStores storeList) {
//  //  print("INSIDE STORE");
//    return
...
//                    shrinkWrap: true,
//                    itemCount: storeList == null ? 0 : 5,
//                    itemBuilder: (context, index) {
//                     // print("Lenght of store" +storeList.results.length.toString());
...
//                                builder: (context) => StoreDetailsState(id: storeList.results[index].id,
//                                ) ));
//                          },
//                          child: AnimationConfiguration.staggeredGrid(
//                              position: index,
//                              duration: const Duration(milliseconds: 375),
//                              columnCount: storeList.results.length,
...
//                                                  children: <Widget>[
//                                                    storeList.results[index]
//                                                        .image_background!=null?   Container(
//
//
//                                                      height: 120,
//
...
//                shrinkWrap: true,
                ...
                shrinkWrap: true,
                itemCount: storeList == null ? 0 : storeList.results.length,
                itemBuilder: (context, index) {
                            ...
                            child: Container(
                                ...
                                child: GestureDetector(
                                    onTap: () {
                                      ...
                                      YoutubeArguments stroeDetilasArguemnts=new
                                          YoutubeArguments(gameId: storeList.results[index].id,gameName: storeList.results[index].name,flag: 1);
                                      Navigator.pushNamed(context, StoreDetails.routeName,arguments: stroeDetilasArguemnts);
//                                      Navigator.push(
//                                          context,
//                                          NavSlideFromRight(
//                                              page: StoreDetailsState(
//                                                storeId: storeList
//                                                    .results[index].id,
//                                                storeName: storeList
//                                                    .results[index].name,
